export function MenuTop() {
    return (
        <div className='flex flex-nowrap justify-start w-full uppercase rounded-md text-[#FAE374] overflow-auto md:justify-around'>
            <a href="#" className='text-lg font-bold m-1 p-2 bg-[#252727] rounded-lg hover:bg-[#4a4d4d]'>Carnes</a>
            <a href="#" className='text-lg font-bold m-1 p-2 bg-[#252727] rounded-lg hover:bg-[#4a4d4d]'>Entradas</a>
